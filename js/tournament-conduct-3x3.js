// To mark the players
function player_dist() {
    var playtot = location.search;
    var playarr = playtot.split("?@!?");
    var x_name = "";
    if(playarr[2] == null) {
        document.getElementById("x_name").innerHTML = "X";
    } else {
        x_name = playarr[2].split("%20");
        if(x_name.length > 1) {
            var i = 0;
            var name = "";
            ...
            document.getElementById("x_name").innerHTML = name;
        } else {
            document.getElementById("x_name").innerHTML = playarr[2];
        }
    }
    if(playarr[4] == null) {
        document.getElementById("o_name").innerHTML = "O";
    } else {
        o_name = playarr[4].split("%20");
        if(o_name.length > 1) {
            var i = 0;
            var name = "";
            ...
            document.getElementById("o_name").innerHTML = name;
        } else {
            document.getElementById("o_name").innerHTML = playarr[4];
        }
    }
    if(playarr[6] == null) {
        document.getElementById("tot_match").innerHTML = 2;
    } else {
        document.getElementById("tot_match").innerHTML = playarr[6];
    }
}
...
function new_match() {
    var curr = parseInt(document.getElementById("curr_match").innerHTML);
    var tot = parseInt(document.getElementById("tot_match").innerHTML);
    if(curr < tot) {
        ...
        document.getElementById("curr_match").innerHTML = curr + 1;
    } else {
        var x_name = document.getElementById("x_name").innerHTML;
        var o_name = document.getElementById("o_name").innerHTML;
        var x_score = document.getElementById("score_x").innerHTML;
        var o_score = document.getElementById("score_o").innerHTML;
        var loc = "tournament-3x3-result.html?@!?X?@!?"+x_name+"?@!?"+x_score+"?@!?O?@!?"+o_name+"?@!?"+o_score+"?@!?M?@!?"+tot;
